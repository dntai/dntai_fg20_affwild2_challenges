...
class VAFramesExprImageBalancedDataLoader(object):
    """
    ...
    def view_image(self, idx_show = None, cols = 8):
        ...
        print(f"View 3D Images: Emotion = {label_name} - {arousal} - {valence}")
